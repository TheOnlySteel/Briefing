...
| Health | `statnews.com`, `nature.com`, `examine.com`, `substack.com` |
| Business | `bankofcanada.ca`, `scotiabank.com`, `fred.stlouisfed.org`, `federalreserve.gov`, `bnnbloomberg.ca`, `ft.com`, `finance.yahoo.com`, `substack.com` |
| Psalm | `api.esv.org` |
